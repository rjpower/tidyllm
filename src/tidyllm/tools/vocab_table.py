...
from tidyllm.types.serialization import from_json_string, to_json_str
...
def vocab_update(
    ...
    if examples is not None:
        ...
        params.append(to_json_str(examples))
    if tags is not None:
        update_parts.append("tags = ?")
        params.append(to_json_str(tags))
