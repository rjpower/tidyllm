...
from tidyllm.tools.file import read_file, write_file
...
class TestFileWrite:
    ...
    def test_write_binary_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = write_file(str(output_path), binary_data)
    ...
    def test_write_text_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = write_file(str(output_path), text_data)
            assert "Written" in result
            assert str(output_path) in result
    ...
    def test_write_creates_parent_dirs(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = write_file(str(output_path), data)
            assert "Written" in result
    ...
    def test_write_with_path_object(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = write_file(output_path, data)
            assert "Written" in result
            assert output_path.read_bytes() == data
...
class TestFileIntegration:
    ...
    def test_read_write_roundtrip(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Write data
            write_result = write_file(str(file_path), original_data)
    ...
    def test_large_file_handling(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Write large data
            write_result = write_file(str(file_path), large_data)
